...
export default function SignUp() {
    ...
    return (
        ...
        <Box width={"100%"} sx={{
            ...
            <Typography textAlign={"center"} paddingTop={"55px"} fontSize={"35px"} fontWeight={"700"} fontFamily={"sans-serif"}>Sign up for a newsletter</Typography>
            <Typography paddingTop={"30px"} textAlign={"center"} fontSize={"14px"}>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore <Typography textAlign={"center"} fontSize={"14px"}>magna aliqua. Ut enim ad minim veniam, quis nostrud exercitat consequat.</Typography></Typography>
            <form onSubmit={handleSubmit}>
            <Stack paddingTop={"70px"} justifyContent={"center"} flexDirection={"row"} alignItems={"baseline"} gap={"16px"}>
