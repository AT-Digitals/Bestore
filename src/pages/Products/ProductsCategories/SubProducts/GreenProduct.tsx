...
import green1 from './GreenProducts/1.jpg'
import green2 from './GreenProducts/2.jpg'
import green3 from './GreenProducts/3.jpg'
import green4 from './GreenProducts/4.jpg'
import green5 from './GreenProducts/5..jpg'
import green6 from './GreenProducts/6.jpg'
import green7 from './GreenProducts/7.jpg'
...
export default function GreenProduct() {
  ...
  const isMediumScreen = useMediaQuery(
    ...
    return (
      ...
      <Grid
        ...
        container
      >
        {GreenProductImages.map((item, index) => (
          <Grid
            columnSpacing={"2rem"}
            rowGap={"4rem"}
            item
