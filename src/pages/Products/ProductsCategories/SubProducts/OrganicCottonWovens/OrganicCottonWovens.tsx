...
import OrganicCottonWovensItems from "./OrganicCottonItems";
...
export default function OrganicCottonWovens() {
  ...
  const relatedProducts = selectedProduct
    ? OrganicCottonWovensItems.filter(
        (item) =>
    ...
    <>
      ...
      <Breadcrumbs
          ...
          >
            ...
            container
          >
              {OrganicCottonWovensItems.map((item, index) => (
                <Grid
                  columnSpacing={"2rem"}
                  rowGap={"4rem"}
                  item
